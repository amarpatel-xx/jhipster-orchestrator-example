...
public class CassAddOnsAvailableByOrganizationDTOId implements Serializable {
    ...
    public CassAddOnsAvailableByOrganizationDTOId(UUID organizationId, String entityType, UUID entityId, UUID addOnId) {
    ...
    public boolean equals(Object o) {
        ...
        CassAddOnsAvailableByOrganizationDTO cassAddOnsAvailableByOrganizationDTO = (CassAddOnsAvailableByOrganizationDTO) o;
        if (this.organizationId == null && this.entityType == null && this.entityId == null && this.addOnId == null) {
            return false;
        }
        return (
            Objects.equals(this.organizationId, cassAddOnsAvailableByOrganizationDTO.getCompositeId().getOrganizationId()) &&
            Objects.equals(this.entityType, cassAddOnsAvailableByOrganizationDTO.getCompositeId().getEntityType()) &&
            Objects.equals(this.entityId, cassAddOnsAvailableByOrganizationDTO.getCompositeId().getEntityId()) &&
            Objects.equals(this.addOnId, cassAddOnsAvailableByOrganizationDTO.getCompositeId().getAddOnId())
        );
    }
