...
public class CassAddOnsSelectedByOrganizationDTO implements Serializable {
    ...
    public void setCompositeId(CassAddOnsSelectedByOrganizationDTOId compositeId) {
        this.compositeId = compositeId;
    }

    public CassAddOnsSelectedByOrganizationDTO compositeId(CassAddOnsSelectedByOrganizationDTOId compositeId) {
        this.compositeId = compositeId;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO customerFirstName(String customerFirstName) {
        this.customerFirstName = customerFirstName;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO customerLastName(String customerLastName) {
        this.customerLastName = customerLastName;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO customerUpdatedEmail(String customerUpdatedEmail) {
        this.customerUpdatedEmail = customerUpdatedEmail;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO customerUpdatedPhoneNumber(String customerUpdatedPhoneNumber) {
        this.customerUpdatedPhoneNumber = customerUpdatedPhoneNumber;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO customerEstimatedArrivalTime(String customerEstimatedArrivalTime) {
        this.customerEstimatedArrivalTime = customerEstimatedArrivalTime;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO tinyUrlShortCode(String tinyUrlShortCode) {
        this.tinyUrlShortCode = tinyUrlShortCode;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO addOnDetailsText(Map<String, String> addOnDetailsText) {
        this.addOnDetailsText = addOnDetailsText;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO addOnDetailsDecimal(Map<String, BigDecimal> addOnDetailsDecimal) {
        this.addOnDetailsDecimal = addOnDetailsDecimal;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO addOnDetailsBoolean(Map<String, Boolean> addOnDetailsBoolean) {
        this.addOnDetailsBoolean = addOnDetailsBoolean;
        return this;
    }
    ...
    public CassAddOnsSelectedByOrganizationDTO addOnDetailsBigInt(Map<String, Long> addOnDetailsBigInt) {
        this.addOnDetailsBigInt = addOnDetailsBigInt;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        CassAddOnsSelectedByOrganizationDTO that = (CassAddOnsSelectedByOrganizationDTO) o;
