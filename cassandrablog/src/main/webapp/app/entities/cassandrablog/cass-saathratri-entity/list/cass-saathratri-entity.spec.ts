...
import { CassSaathratriEntityComponent } from './cass-saathratri-entity';

describe('CassSaathratriEntity Management Component', () => {
  let comp: CassSaathratriEntityComponent;
  let fixture: ComponentFixture<CassSaathratriEntityComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassSaathratriEntityComponent);
