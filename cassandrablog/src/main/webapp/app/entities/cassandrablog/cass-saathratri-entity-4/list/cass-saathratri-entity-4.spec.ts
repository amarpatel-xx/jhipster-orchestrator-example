...
import { CassSaathratriEntity4Component } from './cass-saathratri-entity-4';

describe('CassSaathratriEntity4 Management Component', () => {
  let comp: CassSaathratriEntity4Component;
  let fixture: ComponentFixture<CassSaathratriEntity4Component>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassSaathratriEntity4Component);
