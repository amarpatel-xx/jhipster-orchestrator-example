...
import { CassTajUserComponent } from './cass-taj-user';

describe('CassTajUser Management Component', () => {
  let comp: CassTajUserComponent;
  let fixture: ComponentFixture<CassTajUserComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassTajUserComponent);
