...
import { CassSetEntityByOrganizationComponent } from './cass-set-entity-by-organization';

describe('CassSetEntityByOrganization Management Component', () => {
  let comp: CassSetEntityByOrganizationComponent;
  let fixture: ComponentFixture<CassSetEntityByOrganizationComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassSetEntityByOrganizationComponent);
