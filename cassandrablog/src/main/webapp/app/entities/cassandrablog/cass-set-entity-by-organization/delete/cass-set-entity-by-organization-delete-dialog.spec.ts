...
import { CassSetEntityByOrganizationDeleteDialogComponent } from './cass-set-entity-by-organization-delete-dialog';

describe('CassSetEntityByOrganization Management Delete Component', () => {
  let comp: CassSetEntityByOrganizationDeleteDialogComponent;
  let fixture: ComponentFixture<CassSetEntityByOrganizationDeleteDialogComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassSetEntityByOrganizationDeleteDialogComponent);
