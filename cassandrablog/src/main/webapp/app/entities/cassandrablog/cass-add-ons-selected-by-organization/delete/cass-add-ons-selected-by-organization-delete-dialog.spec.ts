...
import { CassAddOnsSelectedByOrganizationDeleteDialogComponent } from './cass-add-ons-selected-by-organization-delete-dialog';

describe('CassAddOnsSelectedByOrganization Management Delete Component', () => {
  let comp: CassAddOnsSelectedByOrganizationDeleteDialogComponent;
  let fixture: ComponentFixture<CassAddOnsSelectedByOrganizationDeleteDialogComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassAddOnsSelectedByOrganizationDeleteDialogComponent);
