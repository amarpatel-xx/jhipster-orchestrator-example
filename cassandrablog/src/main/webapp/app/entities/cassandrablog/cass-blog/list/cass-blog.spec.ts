...
import { CassBlogComponent } from './cass-blog';

describe('CassBlog Management Component', () => {
  let comp: CassBlogComponent;
  let fixture: ComponentFixture<CassBlogComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassBlogComponent);
