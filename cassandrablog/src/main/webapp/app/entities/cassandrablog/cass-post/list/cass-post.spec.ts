...
import { CassPostComponent } from './cass-post';

describe('CassPost Management Component', () => {
  let comp: CassPostComponent;
  let fixture: ComponentFixture<CassPostComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassPostComponent);
