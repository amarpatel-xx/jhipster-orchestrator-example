...
import { CassPostDeleteDialogComponent } from './cass-post-delete-dialog';

describe('CassPost Management Delete Component', () => {
  let comp: CassPostDeleteDialogComponent;
  let fixture: ComponentFixture<CassPostDeleteDialogComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassPostDeleteDialogComponent);
