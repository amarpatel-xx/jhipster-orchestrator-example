...
import { CassTagComponent } from './cass-tag';

describe('CassTag Management Component', () => {
  let comp: CassTagComponent;
  let fixture: ComponentFixture<CassTagComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CassTagComponent);
