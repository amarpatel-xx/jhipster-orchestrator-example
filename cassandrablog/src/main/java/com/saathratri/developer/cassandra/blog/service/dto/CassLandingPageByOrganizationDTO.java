...
public class CassLandingPageByOrganizationDTO implements Serializable {
    ...
    public CassLandingPageByOrganizationDTO detailsText(Map<String, String> detailsText) {
        this.detailsText = detailsText;
        return this;
    }
    ...
    public CassLandingPageByOrganizationDTO detailsDecimal(Map<String, BigDecimal> detailsDecimal) {
        this.detailsDecimal = detailsDecimal;
        return this;
    }
    ...
    public CassLandingPageByOrganizationDTO detailsBoolean(Map<String, Boolean> detailsBoolean) {
        this.detailsBoolean = detailsBoolean;
        return this;
    }
    ...
    public CassLandingPageByOrganizationDTO detailsBigInt(Map<String, Long> detailsBigInt) {
        this.detailsBigInt = detailsBigInt;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        CassLandingPageByOrganizationDTO that = (CassLandingPageByOrganizationDTO) o;
