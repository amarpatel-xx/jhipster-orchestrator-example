...
public class CassSaathratriEntity4DTOId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        CassSaathratriEntity4DTO cassSaathratriEntity4DTO = (CassSaathratriEntity4DTO) o;
        if (this.organizationId == null && this.attributeKey == null) {
            return false;
        }
        return (
            Objects.equals(this.organizationId, cassSaathratriEntity4DTO.getCompositeId().getOrganizationId()) &&
            Objects.equals(this.attributeKey, cassSaathratriEntity4DTO.getCompositeId().getAttributeKey())
        );
    }
