...
import { PsqlTagDeleteDialog } from './psql-tag-delete-dialog';

describe('PsqlTag Management Delete Component', () => {
  let comp: PsqlTagDeleteDialog;
  let fixture: ComponentFixture<PsqlTagDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PsqlTagDeleteDialog);
