...
import psqlTagResolve from './psql-tag-routing-resolve.service';

describe('PsqlTag routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IPsqlTag returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          psqlTagResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
