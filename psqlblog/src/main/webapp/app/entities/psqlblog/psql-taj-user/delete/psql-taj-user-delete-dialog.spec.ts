...
import { PsqlTajUserDeleteDialog } from './psql-taj-user-delete-dialog';

describe('PsqlTajUser Management Delete Component', () => {
  let comp: PsqlTajUserDeleteDialog;
  let fixture: ComponentFixture<PsqlTajUserDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PsqlTajUserDeleteDialog);
