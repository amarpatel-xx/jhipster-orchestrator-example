...
import { PsqlPostDeleteDialog } from './psql-post-delete-dialog';

describe('PsqlPost Management Delete Component', () => {
  let comp: PsqlPostDeleteDialog;
  let fixture: ComponentFixture<PsqlPostDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PsqlPostDeleteDialog);
