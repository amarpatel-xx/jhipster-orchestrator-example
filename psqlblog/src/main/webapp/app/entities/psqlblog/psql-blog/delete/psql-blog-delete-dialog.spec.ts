...
import { PsqlBlogDeleteDialog } from './psql-blog-delete-dialog';

describe('PsqlBlog Management Delete Component', () => {
  let comp: PsqlBlogDeleteDialog;
  let fixture: ComponentFixture<PsqlBlogDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PsqlBlogDeleteDialog);
