...
import { sampleWithRequiredData } from '../psql-blog.test-samples';
import { PsqlBlogService } from '../service/psql-blog.service';

import { PsqlBlog } from './psql-blog';

vitest.useFakeTimers();

describe('PsqlBlog Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: PsqlBlog;
  let fixture: ComponentFixture<PsqlBlog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PsqlBlog);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '126971d1-2552-470f-b163-e06cf6bfbda4' }], {
    ...
    expect(comp.psqlBlogs()[0]).toEqual(expect.objectContaining({ id: '126971d1-2552-470f-b163-e06cf6bfbda4' }));
  });

  describe('trackId', () => {
    it('should forward to psqlBlogService', () => {
      const entity = { id: '126971d1-2552-470f-b163-e06cf6bfbda4' };
      vitest.spyOn(service, 'getPsqlBlogIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPsqlBlogIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.psqlBlogsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
