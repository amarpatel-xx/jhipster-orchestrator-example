@echo off
setlocal
REM Windows companion for saathratri-generate-code-dev-orchestrator-mf.sh: runs it under Git Bash, forwarding all
...
"%GITBASH%" "%~dp0saathratri-generate-code-dev-orchestrator-mf.sh" %*
exit /b %ERRORLEVEL%
