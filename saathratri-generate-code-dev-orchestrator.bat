@echo off
setlocal
REM Windows companion for saathratri-generate-code-dev-orchestrator.sh: runs it under Git Bash, forwarding all
...
"%GITBASH%" "%~dp0saathratri-generate-code-dev-orchestrator.sh" %*
exit /b %ERRORLEVEL%
