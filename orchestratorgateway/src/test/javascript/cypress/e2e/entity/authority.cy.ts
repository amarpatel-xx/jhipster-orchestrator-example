...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '53709b68-d0d1-4b61-ab7b-122ecfac5687' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'orchestratorgatewayApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('d1c57a55-155d-4891-ad9b-5d704a818faa');
      cy.get(`[data-cy="name"]`).should('have.value', 'd1c57a55-155d-4891-ad9b-5d704a818faa');
