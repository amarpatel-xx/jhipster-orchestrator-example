...
import { PsqlReportDeleteDialog } from './psql-report-delete-dialog';

describe('PsqlReport Management Delete Component', () => {
  let comp: PsqlReportDeleteDialog;
  let fixture: ComponentFixture<PsqlReportDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PsqlReportDeleteDialog);
