...
import { PsqlProductDeleteDialog } from './psql-product-delete-dialog';

describe('PsqlProduct Management Delete Component', () => {
  let comp: PsqlProductDeleteDialog;
  let fixture: ComponentFixture<PsqlProductDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PsqlProductDeleteDialog);
