...
public class CassAddOnsAvailableByOrganizationDTO implements Serializable {
  ...
  public void setCompositeId(
    CassAddOnsAvailableByOrganizationDTOId compositeId
  ) {
    this.compositeId = compositeId;
  }

  public CassAddOnsAvailableByOrganizationDTO compositeId(
    CassAddOnsAvailableByOrganizationDTOId compositeId
  ) {
    this.compositeId = compositeId;
    return this;
  ...
  public CassAddOnsAvailableByOrganizationDTO addOnDetailsText(
  ...
  public CassAddOnsAvailableByOrganizationDTO addOnDetailsDecimal(
    Map<String, BigDecimal> addOnDetailsDecimal
  ) {
    this.addOnDetailsDecimal = addOnDetailsDecimal;
    return this;
  ...
  public CassAddOnsAvailableByOrganizationDTO addOnDetailsBoolean(
  ...
  public CassAddOnsAvailableByOrganizationDTO addOnDetailsBigInt(
  ...
  public boolean equals(Object o) {
    ...
    CassAddOnsAvailableByOrganizationDTO that =
