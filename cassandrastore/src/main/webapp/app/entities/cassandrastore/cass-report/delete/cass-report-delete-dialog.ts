...
@Component({
  templateUrl: './cass-report-delete-dialog.html',
  imports: [FontAwesomeModule, AlertError, TranslateDirective, TranslateModule, FormsModule, ConvertFromDayjsToDateLongPipe],
})
export class CassReportDeleteDialogComponent {
  cassReport?: ICassReport;

  protected cassReportService = inject(CassReportService);
  ...
  confirmDelete(id: string): void {
    this.cassReportService.delete(id).subscribe(() => {
